...
func marshalPublicKey(pub interface{}) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *ecdsa.PublicKey:
		...
		if !ok {
			return nil, pkix.AlgorithmIdentifier{}, errors.New("x5092: unsupported elliptic curve")
		}
...
func parsePublicKey(algo PublicKeyAlgorithm, keyData *publicKeyInfo, nfe *NonFatalErrors) (interface{}, error) {
	...
	case ECDSA:
		...
		if namedCurve == nil {
			return nil, fmt.Errorf("x50921: unsupported elliptic curve %v", namedCurveOID)
		}
