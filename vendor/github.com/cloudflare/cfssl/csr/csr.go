...
// Balgo returns the requested key algorithm represented as a string.
func (bkr *BasicKeyRequest) Balgo() string {
	return bkr.BA
}

// Bsize returns the requested key size.
func (bkr *BasicKeyRequest) Bsize() int {
	return bkr.BS
}
